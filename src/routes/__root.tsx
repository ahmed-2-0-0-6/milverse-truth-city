  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-4 text-sm text-muted-foreground">No such address in this city.</p>
        <div className="mt-6">
          <Link
            to="/"
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-xl font-semibold tracking-tight text-foreground">
          The page didn't make it.
        </h1>
        <p className="mt-2 text-sm text-muted-foreground">
          The fault's on our end. Refresh, or walk back to the city.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      // All fonts are self-hosted via @fontsource in src/styles.css —
      // including the Daily Mirage newsprint set (Playfair, UnifrakturCook).
    ],
  }),
