  ...
  head: () => ({
    meta: [
      { title: "MILVERSE Field Kit — Print & Play in a Classroom" },
      {
        name: "description",
        content:
          "Run MILVERSE with no devices and no internet. Printable card game + PAUSE poster + Trust Calibration scoreboard.",
      },
    ],
  }),
  component: FieldKit,
...
const CARDS: Card[] = [
  {
    ...
    target: {
      scene:
        "An SMS arrives: you've won Rs. 50,000 in a Jazz/Zong 'lucky draw' — just share your CNIC + a small processing fee.",
      dossier: [
      ...
      gaps: ["Which 'draw' is this exactly?", "Would a real prize require you to pay first?"],
    },
    contact: {
      persona: "'Zong Prize Team' agent — polite, official-sounding, uses lots of numbers.",
      opener:
        "Assalamualaikum sir/madam, mubarak ho, aap ki SIM lucky draw mein select hui hai — 50,000 rupay ka prize hai.",
      ...
      doesntKnow: [
        "The target's actual CNIC",
        "Any real campaign details",
        "The target's account balance",
      ],
      deflectionTips: [
    ...
    reveal:
      "Real prize campaigns never charge fees, never need OTPs, and never happen over unsolicited SMS. Any prize that costs money to collect is not a prize.",
  },
  {
    id: "wallet-wrong-tx",
    ...
    target: {
      scene:
        "An unknown number texts you on WhatsApp: 'Bhai galti se aap ko 5000 bhej diye Easypaisa pe, please wapas kar dein, bacha hospital mein hai.'",
      dossier: [
      ...
      gaps: ["Ask for the transaction ID / screenshot.", "Ask which number they claim sent it."],
    },
    contact: {
      persona: "Desperate stranger, emotional, keeps invoking a sick child.",
      opener:
        "Bhai please, mera 4-saal ka beta hospital mein hai, main ne galti se aap ki number pe 5000 bhej diye. Please wapas kar dein.",
      agenda: "Get the target to send 5000 back — before they check their app.",
      knows: ["Their own sob story", "The target's phone number"],
      doesntKnow: [
        "Any real transaction ID",
        "The target's wallet balance",
        "Any bank verification detail",
      ],
      deflectionTips: [
    ...
    reveal:
      "Money that was never sent cannot be sent back. The pressure IS the tell. Real mistakes get resolved by the wallet company, not by begging strangers on WhatsApp.",
  },
  {
    id: "army-buyer-qr",
    ...
    target: {
      scene:
        "You listed a used iPhone on OLX. A buyer calls, says he's a Major posted in Kohat, can't come in person, wants to send payment via a QR code you scan.",
      dossier: [
    ...
    contact: {
      ...
      opener:
        "Assalamualaikum, main Major Bilal, Kohat posted hoon. Aap ka phone chahiye, payment abhi bhejta hoon — bas ek QR scan kar lein.",
    ...
    reveal:
      "In Pakistan, receiving money via QR means YOU are paying. Every real bank transfer needs only your account/IBAN. Rank and pressure are not verification — they are the scam.",
  },
  {
    id: "tiktok-likes-job",
    ...
    target: {
      scene:
        "WhatsApp DM: 'Ghar baithay likes kar ke daily 1500 kamayein.' They pay you Rs. 300 for 3 tasks. Then Task 4 requires a Rs. 5,000 'unlock deposit'.",
      dossier: [
    ...
    contact: {
      ...
      opener:
        "Congratulations! Aap ki 3 tasks complete ho gayi hain — 300 rupay send kar diye. Ab combo task 4 hai — 5,000 deposit karein, 8,000 wapas milega.",
    ...
    reveal:
      "The formula: pay a little to earn trust, then require a 'deposit' to unlock more. Any employer that asks the employee to pay is not an employer.",
  },
  {
    id: "stranded-cousin",
    ...
    target: {
      scene:
        "'Salam bhai, this is Umar — apna phone tuut gaya, kisi ki number se message kar raha hoon. Lahore mein phansa hoon, Uber ke liye 800 rupay bhej sakte ho? Wapas ghar pohanch ke wapas.'",
      dossier: [
    ...
    contact: {
      ...
      opener:
        "Salam bhai, Umar hoon — phone tuut gaya hai, ek dost ki number se likh raha hoon. Lahore mein hoon, thora phansa hoon Uber ke liye. 800 bhej sakte ho? Kal wapas.",
      ...
      doesntKnow: ["Nothing important — he's the real Umar."],
      deflectionTips: [
    ...
    reveal:
      "This is the paranoia test. Real people also get stranded and borrow phones. A calibrated player VERIFIES via one family fact (Umar answers instantly) then sends the Rs. 800. A miscalibrated player interrogates a real cousin like a scammer and burns a real relationship — a False Alarm, scored as a loss.",
  },
  {
    id: "aunty-forward",
    ...
    target: {
      scene:
        "Your aunty forwards a WhatsApp: 'Turmeric + honey mixed with black seed cures diabetes in 7 days. Doctors ki saazish hai isay chupaana. Please forward to 10 people.'",
      dossier: [
    ...
    contact: {
      ...
      opener:
        "Beta, yeh dekho — bahut faida hota hai. Uncle ke liye try karo. Please 10 logon ko bhejo, sawab ka kaam hai.",
    ...
    reveal:
      "The verdict is FALSE — but the relationship must survive. A rude 'this is fake' correction wins the fact and loses the aunty. A respectful correction ('aunty, main ne check kiya, yeh galat hai, uncle ke liye asli doctor se poochh kar bhejta hoon') wins both.",
  },
];
    ...
    <div className="min-h-screen bg-background text-foreground print:bg-white print:text-black">
      ...
      <main className="mx-auto max-w-5xl px-4 py-10 print:px-0 print:py-0 print:max-w-none">
        ...
        <section className="print:min-h-screen print:page-break-after mb-16">
          <div className="font-mono text-xs tracking-[0.3em] text-primary print:text-black mb-4">
            MILVERSE · FIELD KIT · v1
          </div>
          <h1 className="text-4xl sm:text-5xl font-semibold leading-tight tracking-tight">
            No internet? No devices?
            <br />
          ...
          <p className="mt-6 max-w-2xl text-lg text-muted-foreground print:text-neutral-700">
            MILVERSE Field Kit is a printable, offline version of the game for classrooms with no
            laptops, no phones, and no signal. One teacher, one deck of cards, one poster. Same
            skill: <b>verify, don't spot.</b>
          </p>
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 print:grid-cols-2">
            <KitTile
              Icon={BookOpen}
              title="How to run the game"
              desc="Hot-seat rules for a full class."
            />
            <KitTile
              Icon={Users}
              title="6 case card pairs"
              desc="Target dossier + Contact role. 4 imposter, 2 real."
            />
            <KitTile
              Icon={Megaphone}
              title="The PAUSE poster"
              desc="Classroom-wall reminder of the framework."
            />
            <KitTile
              Icon={Grid3x3}
              title="Trust Calibration sheet"
              desc="2x2 grid — teams mark their round."
            />
          </div>
          <p className="mt-10 font-mono text-xs tracking-widest text-muted-foreground print:text-neutral-500">
            Rooted in real reported scam patterns from Pakistan · Fictional personas, no real names
            or logos.
          </p>
        </section>
        ...
        <PrintPage title="How to run the game" subtitle="A full 45-minute classroom round">
          ...
          <ol className="mt-2 space-y-2 list-decimal list-inside text-sm">
            <li>
              Print one <b>Target dossier</b> card and one matching <b>Contact role</b> card for
              each of the 6 cases.
            </li>
            <li>
              Pin the <b>PAUSE poster</b> where every student can see it.
            </li>
            <li>
              Draw the <b>Trust Calibration 2x2</b> on the whiteboard.
            </li>
            <li>
              Split the class into 3–5 teams. Each team is one "Target". Pick one student per team
              to be the Target for round 1 (they rotate).
            </li>
          </ol>
          ...
          <ol className="mt-2 space-y-2 list-decimal list-inside text-sm">
            <li>
              <b>Cast:</b> Teacher picks one student to be the Contact and secretly hands them the
              Contact card. The Contact does NOT show it to anyone.
            </li>
            <li>
              <b>Brief the Target:</b> The Target reads their dossier card silently for 60 seconds,
              then puts it face-down.
            </li>
            <li>
              <b>Play the conversation:</b> Contact opens with their scripted opener. The Target has
              up to 5 questions — no more. The rest of the class watches.
            </li>
            <li>
              <b>The verdict:</b> The Target must declare REAL or IMPOSTER out loud. Class votes
              silently on paper.
            </li>
            <li>
              <b>The reveal:</b> Flip the Contact card. Read the "reveal" section aloud. Mark the
              Target's dot on the 2x2.
            </li>
          </ol>

          <h3 className="font-semibold text-lg mt-6">Teacher's PAUSE debrief script (5 min)</h3>
          <p className="mt-2 text-sm">
            Before revealing, ask the class these five questions in order. Don't answer them — let
            students do it.
          </p>
          <ul className="mt-2 space-y-1 list-disc list-inside text-sm">
            <li>
              <b>P — Pressure:</b> Did the Contact use urgency, guilt, or authority to rush a
              decision?
            </li>
            <li>
              <b>A — Ask an expert / out-of-band:</b> Did the Target try to verify through a second
              channel?
            </li>
            <li>
              <b>U — Unverified claims:</b> What did the Contact claim without evidence? Was any
              evidence offered?
            </li>
            <li>
              <b>S — Story / emotion:</b> Did emotion (fear, guilt, family) override checking?
            </li>
            <li>
              <b>E — Evidence:</b> What ACTUAL evidence did the Target collect vs. rely on gut?
            </li>
          </ul>
          ...
          <ul className="mt-1 list-disc list-inside text-sm">
            <li>
              Believe an <b>Imposter</b> → the scam wins. Team gets a MISSED SCAM mark.
            </li>
            <li>
              Grill a <b>Real</b> contact into leaving → the relationship burns. Team gets a FALSE
              ALARM mark.
            </li>
          </ul>
          <p className="mt-2 text-sm">
            Both are equally costly. Only calibrated verification wins.
          </p>
        </PrintPage>
        ...
        {CARDS.map((c) => (
          <PrintPage
            key={c.id}
            title={`Case: ${c.title}`}
            subtitle={`Tier ${c.tier} · Truth is hidden — do not read the Contact card unless you're playing the Contact.`}
          >
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 print:gap-3">
              ...
              <CardBox label="CONTACT · ROLE (SECRET)" tone="contact">
                ...
                <div className="mt-3">
                  ...
                  <ul className="mt-1 space-y-1 list-disc list-inside text-xs">
                    {c.contact.deflectionTips.map((t, i) => (
                      <li key={i}>{t}</li>
                    ))}
                  </ul>
                </div>
                <div className="mt-3 border-t border-current/30 pt-2">
                  <div className="font-mono text-[10px] tracking-widest opacity-70">
                    REVEAL (READ ALOUD AFTER VERDICT)
                  </div>
        ...
        {/* ── PAUSE POSTER ── */}
        <PrintPage
          title="THE PAUSE — classroom poster"
          subtitle="Print A3 if possible. Pin above the whiteboard."
        >
          <div className="mt-6 border-2 border-current p-8 print:border-black">
            <div className="text-center font-mono text-xs tracking-[0.4em] opacity-70">
              BEFORE YOU BELIEVE ANYTHING · PAUSE
            </div>
            <div className="mt-8 space-y-6">
              {[
                ...
                [
                  "U",
                  "UNVERIFIED",
                  "What is being claimed without proof? What can you actually check?",
                ],
        ...
        {/* ── CALIBRATION SHEET ── */}
        <PrintPage
          title="Trust Calibration Scoreboard"
          subtitle="After each round, teams place a mark for their Target."
        >
          <p className="mt-2 text-sm">
            Two failure modes are equally bad. Track both. The goal is the top-right quadrant:{" "}
            <b>calibrated</b> — believing real people, catching imposters.
          </p>
          <div className="mt-6 border-2 border-current print:border-black">
            <div className="grid grid-cols-[80px_1fr_1fr] print:grid-cols-[80px_1fr_1fr]">
              <div></div>
              <div className="p-3 text-center font-mono text-xs tracking-widest border-l-2 border-current print:border-black">
                CONTACT WAS REAL
              </div>
              <div className="p-3 text-center font-mono text-xs tracking-widest border-l-2 border-current print:border-black">
                CONTACT WAS IMPOSTER
              </div>

              <div className="p-3 font-mono text-xs tracking-widest border-t-2 border-current print:border-black flex items-center justify-center">
                BELIEVED
              </div>
              <div className="p-3 border-l-2 border-t-2 border-current print:border-black min-h-[140px]">
                ...
                <div className="text-xs opacity-70 mt-1">
                  Real contact, believed. Relationship intact.
                </div>
              ...
              <div className="p-3 border-l-2 border-t-2 border-current print:border-black min-h-[140px]">
                ...
                <div className="text-xs opacity-70 mt-1">
                  A real person was burned. Also a loss.
                </div>
                <div className="mt-3 font-mono text-[10px] opacity-60">TEAM MARKS ↓</div>
              </div>
              <div className="p-3 border-l-2 border-t-2 border-current print:border-black min-h-[140px]">
          ...
          <p className="mt-4 text-xs font-mono tracking-widest opacity-60">
            Round after round, a team's dots should cluster in the two ✓ quadrants. Calibration =
            both, not just one.
          </p>
        </PrintPage>
...
function PrintPage({
  ...
  return (
    <section className="print-page mb-16 print:mb-0 print:min-h-screen">
      <div className="font-mono text-xs tracking-[0.3em] text-primary print:text-black">
        MILVERSE · FIELD KIT
      </div>
      <h2 className="mt-2 text-2xl sm:text-3xl font-semibold">{title}</h2>
      {subtitle && (
        <p className="mt-1 text-sm text-muted-foreground print:text-neutral-600">{subtitle}</p>
      )}
      {children}
    </section>
  );
