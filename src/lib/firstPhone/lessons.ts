...
export const LESSONS: Lesson[] = [
  {
    ...
    teach: [
      "Your phone's a door. Some knocks are friends. Some are strangers doing friend impressions.",
      "You don't owe every knock a reply.",
      "Rule zero: when you're not sure, ask.",
      "No adult around right now? Don't reply, don't pay, don't forward. Screenshot it. Show someone later — a parent, teacher, or librarian.",
    ],
    cases: [
      {
        id: "l1-first-forward",
        ...
        options: [
          {
            ...
            correct: false,
            feedback:
              "Phones don't switch off from unforwarded messages. Forwarding is how the trick travels.",
          },
          {
            id: "ignore",
            label: "Ignore and delete",
            correct: true,
            feedback: "Good instinct. A chain letter's threat is the whole trick.",
          },
        ],
        adultScene: {
          who: "Baba",
          line: "Beta, that's a chain letter. Used to come on paper. Ignore.",
        },
        ...
        options: [
          {
            ...
            correct: false,
            feedback: "Never send a password. Real companies never ask — not once, not ever.",
          },
          {
            id: "report",
            label: "Report and block",
            correct: true,
            feedback: "Sharp. Passwords stay with you. Reporting saves the next kid too.",
          },
        ],
        adultScene: {
          who: "Nani",
          line: "Haan haan, ye chor. Free ke naam pe account chura ke bech dete hain. You just held on to yours.",
        },
    ...
    cases: [
      {
        ...
        options: [
          {
            ...
            correct: false,
            feedback: "Auntie's kind. The claim still isn't true. Sharing puts it on more phones.",
          },
          {
            id: "reply",
        ...
        adultScene: {
          who: "Ammi",
          line: "Auntie means well. Send her the real article — that's how we help without embarrassing anyone.",
        },
        ...
        options: [
          {
            ...
            correct: false,
            feedback: "The photo is real. The story isn't. Different country, five years ago.",
          },
          {
            id: "check",
            label: "Reverse-image search first",
            correct: true,
            feedback: "Exactly. Real photo, wrong story. One tap caught it.",
          },
        ],
        adultScene: {
          who: "Baba",
          line: "Same photo did the rounds three years back. Different country. Good catch.",
        },
        truthNote:
          "Out-of-context images are the most-shared fake there is. Reverse search is your friend.",
      },
    ],
  },
  {
    ...
    cases: [
      {
        ...
        options: [
          ...
          },
          {
            ...
            correct: true,
            feedback:
              "Perfect move. If it's Ali, he picks up. If it's not, you didn't hand over your keys.",
          },
        ],
        adultScene: {
          who: "Older cousin",
          line: "Bro. Classic OTP scam. I've seen it twice this month. Never send codes — not even to me.",
        },
        truthNote:
        ...
        options: [
          {
            ...
            correct: false,
            feedback: "Voices get copied now. Money + urgency + unknown number is the tell.",
          },
          {
            id: "call",
            label: "Call Nani's saved number first",
            correct: true,
            feedback: "Exactly. A voice isn't proof anymore. A callback is.",
          },
        ],
        adultScene: {
          who: "Baba",
          line: "That was an AI voice. Nani's at home eating mangoes. Good callback.",
        },
    ...
    cases: [
      {
        ...
        options: [
          ...
          },
          {
            ...
            correct: true,
            feedback: "That's HOLD. Can't verify = don't move. Ask.",
          },
        ],
        adultScene: {
          who: "Baba (on call)",
          line: "No, beta. I didn't send anyone. Stay inside. I'm on my way.",
        },
    ...
    cases: [
      {
        ...
        options: [
          ...
          },
          {
            ...
            correct: true,
            feedback: "That's the family checker at work. One kind reply, chain broken.",
          },
        ],
        adultScene: {
          who: "Ammi",
          line: "Look — five people stopped forwarding after your reply. That's how a chat cleans itself.",
        },
  ...
  },
  {
    ...
    teach: [
      "Real cases mix tricks. You'll get impersonation, urgency, and fake proof — all in one.",
      "Use the moves. Call backup when you need it.",
    ...
    cases: [
      {
        ...
        options: [
          ...
          },
          {
            ...
            correct: true,
            feedback: "You caught all three. That's a licensed operator right there.",
          },
        ],
        adultScene: {
          who: "Baba (on call)",
