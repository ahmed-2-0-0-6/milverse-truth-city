...
const FORM_A: AssessmentItem[] = [
  {
    id: "A1", pairId: "P1", form: "A",
    tactic: "friend-text", difficulty: "easy",
    artifact:
  ...
  {
    id: "A2", pairId: "P2", form: "A",
    tactic: "prize-bait", difficulty: "easy",
    artifact:
  ...
  {
    id: "A3", pairId: "P3", form: "A",
    tactic: "sourced-news", difficulty: "medium",
    artifact:
  ...
  {
    id: "A4", pairId: "P4", form: "A",
    tactic: "bank-phish", difficulty: "medium",
    artifact:
  ...
  {
    id: "A5", pairId: "P5", form: "A",
    tactic: "out-of-context", difficulty: "medium",
    artifact:
  ...
  {
    id: "A6", pairId: "P6", form: "A",
    tactic: "unverifiable-forward", difficulty: "medium",
    artifact:
