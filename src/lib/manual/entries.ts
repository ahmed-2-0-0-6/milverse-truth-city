...
export const MANUAL_ENTRIES: ManualEntry[] = [
  {
    ...
    worldwide: [
      { where: "South Asia · daily", pattern: '"Bhai I lost my phone, quick send Rs 5000 easypaisa" from a number claiming to be a close relative.' },
      { where: "Global · workplaces", pattern: '"CEO" texts a junior finance staffer asking for an urgent gift-card purchase — a "small favour, deal with it directly".' },
    ],
    redFlags: [
    ...
    counterMove: "Call the person you know on the number you already have. If they can't hop on video for 30 seconds, they aren't them.",
  },
  {
    id: "urgency-fear",
    code: "T-02",
    ...
    worldwide: [
      { where: "Pakistan", pattern: '"All banks closing for 5 days — withdraw NOW" resurfaces during every currency wobble.' },
      { where: "Global", pattern: '"Your parcel is held at customs, pay ₹XX within 2 hours or it will be destroyed."' },
    ],
    redFlags: [
    ...
    counterMove: "The pause IS the defence. Any legit deadline survives a 20-minute delay. If it doesn't, it wasn't legit.",
  },
  {
    id: "out-of-context",
    code: "T-03",
    ...
    worldwide: [
      { where: "Global · every disaster", pattern: "Old flood/protest/war photos from another country recycled as 'today, here'." },
      { where: "Global · politics", pattern: "A 30-second clip of a real speech, stitched from three different moments, reverses the speaker's actual point." },
    ],
    redFlags: [
    ...
    counterMove: "Reverse-image the picture. Find the full clip. The real source of a real photo will always exist somewhere — go find it before you share.",
  },
  {
    id: "engagement-bait",
    code: "T-04",
    ...
    worldwide: [
      { where: "Global · social platforms", pattern: "Screenshot of an outrageous 'tweet' from a made-up account that never existed." },
      { where: "Global · health", pattern: "'Doctors hate this' clickbait framing on ordinary content." },
    ],
    redFlags: [
    ...
    counterMove: "Ask: who benefits if I share this angry? If the answer is 'a stranger's engagement graph', don't be their algorithm.",
  },
  {
    id: "imposter-outlet",
    code: "T-05",
    ...
    worldwide: [
      { where: "Global · phishing", pattern: '"State Bank of Pak1stan" with a numeric 1, or "gov-pk.org" instead of "gov.pk".' },
      { where: "Global · fake news", pattern: '"BBC-News-Updates" with a slightly different logo publishes an invented story.' },
    ],
    redFlags: [
    ...
    counterMove: "Open the real outlet in a new tab yourself. If the story isn't there, the story isn't real.",
  },
  {
    id: "phishing",
    code: "T-06",
    ...
    worldwide: [
      { where: "Global · banking", pattern: '"Your account has been suspended, click to reactivate" pointing to a lookalike login page.' },
      { where: "South Asia", pattern: '"Free government laptop / job — send CNIC + Rs 250 processing fee to this personal wallet."' },
    ],
    redFlags: [
    ...
    counterMove: "Real institutions never ask for OTPs, and never charge personal wallets for free benefits. Type the domain by hand — never click through.",
  },
  {
    id: "trust-farming",
    code: "T-07",
    ...
    worldwide: [
      { where: "Global · romance scams", pattern: "\"Wrong number\" or dating-app match escalates to a foreign 'partner' with an urgent hospital bill." },
      { where: "Global · trafficking", pattern: "'Modelling / overseas job' relationships built over months to extract passport photos and travel consent." },
    ],
    redFlags: [
    ...
    counterMove: "Ask yourself: what would day-one me say to this ask? Show the conversation to someone offline. Reverse-image their photos.",
  },
  {
    id: "ai-generated",
    code: "T-08",
    ...
    worldwide: [
      { where: "Global", pattern: "AI-cloned voice of a family member asking for money over a phone call." },
      { where: "Global", pattern: "AI-generated 'photo' of an event that never happened, shared as breaking news." },
    ],
    redFlags: [
    ...
    counterMove: "Verify the source, not the pixels. Call back on the number you already have. Find the same event reported by two independent outlets.",
  },
  {
    id: "mis-dis-mal",
    code: "T-09",
    ...
    worldwide: [
      { where: "Global", pattern: "The same false claim is misinformation in a family group and disinformation when a paid operator plants it." },
      { where: "Global", pattern: "A real leaked screenshot used out of context to destroy a reputation is malinformation, not fake news." },
    ],
    redFlags: [
    ...
    counterMove: "Name it out loud before you react. The response to a scared aunt is not the response to a paid operator.",
  },
  {
    id: "forgery-engine",
    code: "T-10",
    ...
    worldwide: [
      { where: "Global · finance", pattern: "A deepfaked video of a CEO used to authorise a wire transfer during a live call." },
      { where: "Global · politics", pattern: "A cloned voice of a public figure 'admitting' something they never said, released hours before a vote." },
    ],
    redFlags: [
