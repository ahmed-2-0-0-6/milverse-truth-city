...
export const BASE_CONTACTS: SavedContact[] = [
  ...
  {
    id: "bank-helpline",
    name: "Bank Helpline (from card)",
    number: "111 111 111",
    role: "HBL — from card back",
  },
...
export const BOSS_CONTACTS: Record<string, SavedContact[]> = {
  "ghost-of-bali": [
    {
      id: "ghost-known",
      name: "Him (saved number)",
      number: "+92 321 4459812",
      role: "Best friend",
      protocolMove: "callback_known",
    },
    {
      id: "ghost-sister",
      name: "His sister",
      number: "+92 333 7788221",
      role: "Second person",
      protocolMove: "second_person",
    },
    {
      id: "ghost-office",
      name: "His office manager",
      number: "+92 21 3456 7891",
      role: "Second person",
      protocolMove: "second_person",
    },
  ],
  "the-twin": [
    {
      id: "twin-known",
      name: "Cousin (saved number)",
      number: "+92 300 1129847",
      role: "Family",
      protocolMove: "outbound_video",
    },
    {
      id: "twin-aunt",
      name: "Aunt",
      number: "+92 333 4471129",
      role: "Family",
      protocolMove: "second_person",
    },
  ],
  "the-chorus": [
    {
      id: "chorus-desk",
      name: "Newsroom desk (verified)",
      number: "+92 21 111 100 100",
      role: "Provenance",
      protocolMove: "provenance_trace",
    },
    {
      id: "chorus-wait",
      name: "Wait past the window",
      number: "—",
      role: "Discipline",
      protocolMove: "delay_past_window",
    },
  ],
};
...
export function detectAmount(text: string): string | null {
  const m = text.match(
    /(USD|EUR|GBP|£|\$|€|₨|PKR|Rs\.?)\s?([\d,]+(?:\.\d+)?)|(₨|Rs\.?)\s?([\d,]+)|([\d,]+)\s?(USD|EUR|GBP|PKR)/i,
  );
  if (!m) return null;
