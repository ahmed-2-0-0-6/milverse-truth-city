      ...
      >
        {(() => {
          ...
          const brands: Brand[] = [
            ...
            // Wikipedia — the W (SimpleIcons), white
            {
              id: "wiki", x: 1080, y: 90, size: 48, color: "#FFFFFF",
              d: "M12.09 13.119c-.936 1.932-2.217 4.548-2.853 5.728-.616 1.074-1.127.931-1.532.029-1.406-3.321-4.293-9.144-5.651-12.409-.251-.601-.441-.987-.638-1.028-.628-.084-1.294-.156-1.409-.181L0 5.019l.007-.75 6.501.032.007.755-.53.086c-.877.043-.712.65-.13 1.898l4.618 9.687 2.868-5.698-.937-2.276-1.906-3.774c-.939-1.516-1.847-1.114-1.897-1.116L8.353 5.02l.007-.75 5.617.032v.755l-.271.086c-.865.05-1.114.361-.578 1.542.882 1.828 1.37 2.983 2.132 4.514L18.086 5.68c1.043-2.078-.412-2.031-.899-2.02l-.437-.087.007-.755 5.24.032v.751l-.416.181c-1.098.101-1.723 1.031-2.259 2.026L14.717 12.11l3.323 6.822L23.288 7.36c.694-1.646.383-2.062-.383-2.276l-.427-.114V4.253l4.353.032.007.75-.586.116c-1.283.235-1.526.646-1.976 1.615L18.166 22.11c-.664 1.463-1.055 1.516-1.727.101L12.09 13.119z",
            },
          ];
          return brands.map((b) => {
            const s = b.size ?? 46;
