      ...
      >
        {(() => {
          ...
          const brands: Brand[] = [
            ...
            // Wikipedia — clean W wordmark, white
            {
              id: "wiki", x: 110, y: 110, size: 48, color: "#FFFFFF",
              d: "M2 5 L6 5 L8.4 15.8 L11 5 L13 5 L15.6 15.8 L18 5 L22 5 L17.6 20 L14.3 20 L12 12 L9.7 20 L6.4 20 Z",
            },
          ];
          return brands.map((b) => {
            const s = b.size ?? 46;
