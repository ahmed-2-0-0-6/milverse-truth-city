    ...
    <div className="thesis-backdrop absolute inset-0 overflow-hidden">
      ...
      <svg className="absolute inset-0 h-full w-full opacity-[0.14]" viewBox="0 0 1200 700" fill="none">
        <g stroke="rgba(200,230,255,0.9)" strokeWidth="1.2" fill="none">
          ...
          {/* Tiny social platform glyphs — accurate brand marks (SimpleIcons-style paths),
              rendered as filled shapes so they read at a glance. Kept in the outer gutters
              so MEDIA / INFO / LITERACY cards in the center stay clear. */}
          {(() => {
            const BRAND_FILL = "rgba(200,230,255,0.92)";
            const brands: { id: string; x: number; y: number; size?: number; d: string }[] = [
              // Instagram — camera body + lens + top-right dot
              {
                id: "ig", x: 288, y: 60, size: 46,
                d: "M12 2.2c2.7 0 3 0 4.1.1 1 0 1.5.2 1.9.4.5.2.9.4 1.3.8.4.4.6.8.8 1.3.2.4.3.9.4 1.9.1 1.1.1 1.4.1 4.1s0 3-.1 4.1c0 1-.2 1.5-.4 1.9-.2.5-.4.9-.8 1.3-.4.4-.8.6-1.3.8-.4.2-.9.3-1.9.4-1.1.1-1.4.1-4.1.1s-3 0-4.1-.1c-1 0-1.5-.2-1.9-.4-.5-.2-.9-.4-1.3-.8-.4-.4-.6-.8-.8-1.3-.2-.4-.3-.9-.4-1.9C2.2 15 2.2 14.7 2.2 12s0-3 .1-4.1c0-1 .2-1.5.4-1.9.2-.5.4-.9.8-1.3.4-.4.8-.6 1.3-.8.4-.2.9-.3 1.9-.4C7.8 3.4 8.1 3.4 12 3.4Zm0 1.8c-2.6 0-2.9 0-4 .1-.9 0-1.4.2-1.7.3-.4.2-.7.4-1 .7-.3.3-.5.6-.7 1-.1.3-.3.8-.3 1.7-.1 1.1-.1 1.4-.1 4s0 2.9.1 4c0 .9.2 1.4.3 1.7.2.4.4.7.7 1 .3.3.6.5 1 .7.3.1.8.3 1.7.3 1.1.1 1.4.1 4 .1s2.9 0 4-.1c.9 0 1.4-.2 1.7-.3.4-.2.7-.4 1-.7.3-.3.5-.6.7-1 .1-.3.3-.8.3-1.7.1-1.1.1-1.4.1-4s0-2.9-.1-4c0-.9-.2-1.4-.3-1.7-.2-.4-.4-.7-.7-1-.3-.3-.6-.5-1-.7-.3-.1-.8-.3-1.7-.3-1.1-.1-1.4-.1-4-.1Zm0 3.1a4.9 4.9 0 1 1 0 9.8 4.9 4.9 0 0 1 0-9.8Zm0 1.8a3.1 3.1 0 1 0 0 6.2 3.1 3.1 0 0 0 0-6.2Zm5.1-2a1.15 1.15 0 1 1 0 2.3 1.15 1.15 0 0 1 0-2.3Z",
              },
              // Reddit — snoo silhouette (SimpleIcons)
              {
                id: "reddit", x: 330, y: 195, size: 46,
                d: "M12 0a12 12 0 1 0 12 12A12 12 0 0 0 12 0Zm5.86 12.85a1.55 1.55 0 0 1 0 3.09h-.07a4.28 4.28 0 0 1 .05.61c0 2.63-3.11 4.75-6.94 4.75s-6.94-2.12-6.94-4.75a4.28 4.28 0 0 1 .05-.61h-.07a1.55 1.55 0 1 1 1.02-2.71 8.5 8.5 0 0 1 4.61-1.44l.87-4.11a.34.34 0 0 1 .4-.26l2.85.61a1.13 1.13 0 1 1-.11 1.02l-2.55-.54-.78 3.7a8.5 8.5 0 0 1 4.55 1.42 1.55 1.55 0 0 1 1.06-.28ZM9.25 12a1.25 1.25 0 1 0 1.25 1.25A1.25 1.25 0 0 0 9.25 12Zm5.5 0a1.25 1.25 0 1 0 1.25 1.25A1.25 1.25 0 0 0 14.75 12Zm-.55 4.03a.35.35 0 0 0-.5 0 3.36 3.36 0 0 1-2.2.68 3.36 3.36 0 0 1-2.2-.68.36.36 0 1 0-.5.51 4.06 4.06 0 0 0 2.7.89 4.06 4.06 0 0 0 2.7-.89.35.35 0 0 0 0-.51Z",
              },
              // YouTube — rounded rectangle + triangle
              {
                id: "yt", x: 258, y: 358, size: 50,
              ...
              // TikTok — musical note figure
              {
                id: "tt", x: 300, y: 618, size: 46,
              ...
              // Snapchat — ghost
              {
                id: "sc", x: 878, y: 60, size: 46,
                d: "M12.2 2c2.9 0 5.4 1.7 6.5 4.3.4 1 .4 2 .3 3.1v.4c0 .5 0 1 .1 1.2 0 .2.4.4.7.5.2 0 .4.1.6.1.4.1 1.2.3 1.2.9 0 .4-.4.7-1.2 1-.1 0-.3.1-.5.1-.7.2-1.7.5-2 1.3-.2.4-.1.9.2 1.6 0 0 1.2 2.8 4 3.2.2 0 .4.2.4.5 0 .1 0 .1-.1.2-.4 1-2.2 1.6-3.5 1.8-.1 0-.1.2-.2.5 0 .1-.1.4-.1.6-.1.4-.4.6-.7.6h-.1c-.2 0-.5-.1-.9-.1-.2-.1-.5-.1-.9-.1-.2 0-.5 0-.8.1-.6.1-1.1.4-1.7.9-.8.7-1.7 1.5-3.1 1.5H10c-1.4 0-2.3-.8-3.1-1.5-.6-.5-1.1-.8-1.7-.9-.3-.1-.6-.1-.8-.1-.4 0-.7 0-.9.1-.4.1-.7.1-.9.1-.4 0-.6-.3-.7-.7 0-.2-.1-.5-.1-.6-.1-.3-.1-.4-.2-.5-1.3-.2-3.1-.8-3.5-1.8v-.2c0-.3.2-.5.4-.5 2.9-.5 4-3.2 4-3.2.3-.7.3-1.2.2-1.6-.3-.8-1.3-1-2-1.3-.2 0-.3-.1-.5-.1-1-.4-1.2-.8-1.2-1 0-.6.8-.8 1.2-.9.2-.1.4-.1.6-.2.3-.1.7-.3.7-.5 0-.2.1-.7.1-1.2v-.4c-.1-1.1-.1-2.1.3-3.1C6.8 3.7 9.3 2 12.2 2Z",
              },
              // Facebook — f mark
              {
                id: "fb", x: 858, y: 185, size: 46,
              ...
              // OpenAI / GPT — hex knot
              {
                id: "gpt", x: 1070, y: 470, size: 48,
                d: "M22.3 9.86a5.94 5.94 0 0 0-.51-4.88 6 6 0 0 0-6.47-2.88A5.99 5.99 0 0 0 4.98 4.18a5.94 5.94 0 0 0-3.97 2.88 6 6 0 0 0 .74 7.03 5.94 5.94 0 0 0 .51 4.88 6 6 0 0 0 6.47 2.88 5.99 5.99 0 0 0 10.34-2.08 5.94 5.94 0 0 0 3.97-2.88 6 6 0 0 0-.74-7.03ZM13.26 20.6a4.44 4.44 0 0 1-2.85-1.03l.14-.08 4.73-2.73a.77.77 0 0 0 .39-.67v-6.67l2 1.16a.07.07 0 0 1 .04.06v5.52a4.46 4.46 0 0 1-4.45 4.44Zm-9.55-4.08a4.42 4.42 0 0 1-.53-2.97l.14.08 4.73 2.73a.77.77 0 0 0 .78 0l5.78-3.34v2.31a.08.08 0 0 1-.03.07l-4.79 2.76a4.46 4.46 0 0 1-6.08-1.64ZM2.46 8.24a4.43 4.43 0 0 1 2.31-1.94v5.62a.76.76 0 0 0 .39.67l5.75 3.32-2 1.16a.08.08 0 0 1-.07 0L4.06 14.3a4.46 4.46 0 0 1-1.6-6.06ZM18.6 11.99 12.82 8.66l2-1.15a.08.08 0 0 1 .07 0l4.78 2.76a4.45 4.45 0 0 1-.67 8.03V12.66a.79.79 0 0 0-.4-.67Zm1.99-3 -.14-.09-4.72-2.75a.77.77 0 0 0-.78 0L9.17 9.49V7.18a.08.08 0 0 1 .03-.07l4.79-2.76a4.45 4.45 0 0 1 6.61 4.61ZM8.08 13.1l-2-1.16a.08.08 0 0 1-.04-.06V6.37a4.45 4.45 0 0 1 7.3-3.42l-.14.08L8.47 5.76a.77.77 0 0 0-.39.67Zm1.09-2.34 2.57-1.49 2.58 1.49v2.97l-2.58 1.49-2.57-1.49Z",
              },
            ];
            return brands.map((b) => (
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d={b.d} fill={BRAND_FILL} stroke="none" />
              </svg>
            ));
          })()}
        </g>
