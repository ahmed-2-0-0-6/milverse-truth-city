      ...
      >
        {(() => {
          ...
          const brands: Brand[] = [
            ...
            // Wikipedia — reference-matched serif W, parked in the far left gutter
            {
            ...
            {
              id: "wa", x: 180, y: 140, size: 44, color: "#25D366",
            ...
            // Google — blue G, left gutter (verification / search)
            {
              id: "google", x: 40, y: 410, size: 44, color: "#4285F4",
            ...
            // LinkedIn — professional misinfo, left gutter
            {
              id: "in", x: 190, y: 480, size: 42, color: "#0A66C2",
              d: "M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.063 2.063 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z",
            },
            // Twitch — livestream, left gutter (needs disc for purple on dark)
            {
              id: "twitch", x: 30, y: 560, size: 42, color: "#9146FF",
              d: "M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714Z",
            },
            // Canva — creative tools, right gutter (needs disc — teal on dark)
            {
              id: "canva", x: 950, y: 100, size: 46, color: "#00C4CC",
              d: "M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0Zm-1.06 5.03c1.714 0 2.6.314 2.6 1.254 0 .096-.145.192-.145.336 0 .192.144.24.336.24.192 0 .336-.096.336-.24 0-.096-.048-.192-.048-.336 0-.144.048-.348.144-.492.096-.144.144-.299.144-.492 0-.63-.684-1.132-1.717-1.132-1.54 0-2.916.866-3.94 2.164C7.626 7.63 7.077 9.399 7.077 10.886c0 2.087 1.147 3.694 3.256 3.694 1.673 0 3.174-1.157 3.783-2.42.07-.149.157-.238.35-.238.192 0 .329.148.28.386-.173.839-.905 1.738-1.885 2.416-.98.677-2.224 1.128-3.487 1.128-1.435 0-2.713-.348-3.582-1.222-.869-.875-1.311-2.282-1.311-3.892 0-1.51.386-3.222 1.216-4.65C7.32 6.395 8.923 5.03 10.94 5.03Z",
            },
            // Gemini — Google AI, right gutter
            {
              id: "gemini", x: 1080, y: 100, size: 46, color: "#8E75FF",
